...
struct Gesture: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        Examples:
          taptaptap ui gesture scroll-up --udid SIMULATOR_UDID
          taptaptap ui gesture scroll-down --duration 1.5 --udid SIMULATOR_UDID
          taptaptap ui gesture swipe-from-left-edge --screen-width 430 --screen-height 932 --udid SIMULATOR_UDID
        """
    )
