...
struct KeyCombo: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        Examples:
          taptaptap key-combo --modifiers 227 --key 4 --udid SIMULATOR_UDID          # Cmd+A (Select All)
          taptaptap key-combo --modifiers 227 --key 6 --udid SIMULATOR_UDID          # Cmd+C (Copy)
          taptaptap key-combo --modifiers 227 --key 25 --udid SIMULATOR_UDID         # Cmd+V (Paste)
          taptaptap key-combo --modifiers 227,225 --key 4 --udid SIMULATOR_UDID      # Cmd+Shift+A
        """
    )
