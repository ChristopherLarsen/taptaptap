...
struct OrientationAwareCoordinates {
    ...
    static func detectMapping(
        ...
        throw CLIError(errorDescription: "Unable to determine rotated simulator orientation. TapTapTap can read landscape coordinates only when SimulatorKit reports the current UI orientation; the screenshot confirms the simulator is rotated, but the private orientation probe was unavailable.")
    }
